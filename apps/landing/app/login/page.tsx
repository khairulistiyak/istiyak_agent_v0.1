...
import { Bot, Mail, Lock, Eye, EyeOff, AlertTriangle } from "lucide-react";
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.85rem", color: "#9ca3af", margin: 0 }}>
            Sign in to manage your AI Companion space
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.35rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <a href="/forgot-password" style={{ fontSize: "0.75rem", color: "#06b6d4", textDecoration: "none" }}>Forgot?</a>
            </div>
            <div style={{ position: "relative" }}>
        ...
        <div style={{ marginTop: "2rem", textAlign: "center", fontSize: "0.8rem", color: "#9ca3af" }}>
          ...
          <a href="/register" style={{ color: "#06b6d4", textDecoration: "none", fontWeight: 600 }}>
            Create free account
          </a>
        </div>
      </div>
